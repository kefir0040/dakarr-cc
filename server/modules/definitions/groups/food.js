...
Class.cube = {
  ...
  COLOR: "egg",
  SHAPE:
    "M -0.13 0.07 L -0.87 -0.35 L -0.87 0.5 L -0.13 0.93 Z M 0.13 0.07 L 0.13 0.93 L 0.87 0.5 L 0.87 -0.35 Z M 0 -0.15 L 0.74 -0.57 L 0 -1 L -0.74 -0.57 Z",
  BODY: {
    DAMAGE: 4.8,
    DENSITY: 20,
    HEALTH: 40,
...
Class.tetrahedron = {
  ...
  COLOR: "egg",
  SHAPE:
    "M -0.13 0.07 L -0.87 -0.35 L -0.13 0.92 Z M 0.13 0.07 L 0.13 0.92 L 0.87 -0.35 Z M 0 -0.15 L 0.74 -0.57 L -0.74 -0.57 Z",
  BODY: {
    DAMAGE: 6,
    DENSITY: 23,
    HEALTH: 50,
...
Class.octahedron = {
  ...
  COLOR: "egg",
  SHAPE:
    "M -0.12 -0.12 L -0.12 -0.88 L -0.88 -0.12 Z M -0.12 0.12 L -0.88 0.12 L -0.12 0.88 Z M 0.12 0.12 L 0.12 0.88 L 0.88 0.12 Z M 0.12 -0.12 L 0.88 -0.12 L 0.12 -0.88 Z",
  BODY: {
    DAMAGE: 6.5,
    DENSITY: 26,
    HEALTH: 60,
...
Class.dodecahedron = {
  ...
  COLOR: "egg",
  SHAPE:
    "M -0.28 -0.39 H 0.28 L 0.455 0.15 L 0 0.48 L -0.455 0.15 Z M -0.951 -0.309 L -0.957 0.194 L -0.659 0.102 L -0.473 -0.469 L -0.66 -0.719 Z M -0.588 0.809 L -0.111 0.97 L -0.107 0.658 L -0.592 0.305 L -0.888 0.406 Z M 0.588 0.809 L 0.888 0.406 L 0.593 0.305 L 0.107 0.658 L 0.111 0.97 Z M 0.951 -0.309 L 0.66 -0.719 L 0.473 -0.469 L 0.659 0.102 L 0.957 0.194 Z M 0 -1 L -0.48 -0.85 L -0.3 -0.595 H 0.3 L 0.48 -0.85 Z",
  BODY: {
    DAMAGE: 7,
    DENSITY: 28,
    HEALTH: 70,
...
Class.icosahedron = {
  ...
  COLOR: "egg",
  SHAPE:
    "M -0.84 0.485 L -0.196 0.621 L -0.636 -0.141 Z M 0.733 -0.319 L 0.912 0.27 L 0.911 -0.422 Z M 0.643 -0.475 L 0.222 -0.925 L 0.821 -0.578 Z M 0.84 0.485 L 0.636 -0.141 L 0.196 0.621 Z M -0.643 -0.475 L -0.222 -0.925 L -0.821 -0.578 Z M -0.733 -0.319 L -0.912 0.27 L -0.911 -0.422 Z M 0 -0.97 L -0.44 -0.48 L 0.44 -0.48 Z M -0.09 0.794 L -0.69 0.655 L -0.09 1 Z M 0.09 0.794 L 0.69 0.655 L 0.09 1 Z M 0 0.62 L -0.537 -0.31 L 0.537 -0.31 Z",
  BODY: {
    DAMAGE: 9,
    DENSITY: 30,
    HEALTH: 80,
...
Class.tesseract = {
  ...
  COLOR: "egg",
  SHAPE:
    "M 0.34 0.47 L 0.58 0.71 L -0.58 0.71 L -0.34 0.47 Z M 0.47 -0.34 L 0.71 -0.58 L 0.71 0.58 L 0.47 0.34 Z M -0.34 -0.47 L -0.58 -0.71 L 0.58 -0.71 L 0.34 -0.47 Z M -0.47 0.34 L -0.71 0.58 L -0.71 -0.58 L -0.47 -0.34 Z M 0.32 0.32 L 0.32 -0.32 L -0.32 -0.32 L -0.32 0.32 L 0.32 0.32",
  BODY: {
    DAMAGE: 10,
    DENSITY: 40,
    RESIST: 1.25,
...
for (let tier = 0; tier < 6; tier++) {
  for (let poly in polyNames) {
    ...
    for (let shiny in shinyNames) {
      ...
      let base = `shape_${tier}_${poly}_${shiny}_base`;
      let crasher = `shape_${tier}_${poly}_${shiny}_crasher`;
      ...
      Class[crasher] = makeCrasher(Class[base]);
    }
  }
}
