    ...
    GUNS: [
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.twin,
            g.power,
            { speed: 0.7, maxSpeed: 0.7, recoil: 0.01 },
          ]),
          TYPE: "bullet",
        },
      },
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            g.trap,
            g.lowPower,
            { shudder: 0.4, speed: 0.9, reload: 2 },
          ]),
          TYPE: "trap",
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.pounder,
            g.hexaTrapper,
            { size: 1.2, speed: 0.9, shudder: 0.1 },
          ]),
          TYPE: "trap",
          STAT_CALCULATOR: "trap",
          AUTOFIRE: true,
...
Class.shottrapTurret = makeTurret(
  {
    GUNS: [
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.trap, g.setTrap, g.shotgun, g.fake]),
          AUTOFIRE: true,
          TYPE: "bullet",
        },
      },
...
Class.launcherTurret = makeTurret("launcher", {
  canRepel: true,
  limitFov: true,
  extraStats: [],
});
Class.skimmerTurret = makeTurret("skimmer", {
  canRepel: true,
  limitFov: true,
  extraStats: [],
  color: "mirror",
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.artillery,
            g.skimmer,
            { reload: 2, speed: 1.5, maxSpeed: 1.5, range: 2.5 },
          ]),
...
Class.twisterTurret = makeTurret("twister", {
  canRepel: true,
  limitFov: true,
  color: "mirror",
  extraStats: [{ speed: 1.3, maxSpeed: 1.3 }],
});
...
Class.rocketeerTurret = makeTurret("rocketeer", {
  canRepel: true,
  limitFov: true,
});
Class.boomerTurret = makeTurret("boomer", {
  canRepel: true,
  limitFov: true,
  color: "mirror",
  extraStats: [],
...
Class.barricadeTurret = makeTurret("barricade", {
  aiSettings: {
    SKYNET: true,
    FULL_VIEW: true,
    independent: true,
...
Class.artilleryTurret = makeTurret("artillery", {
  canRepel: true,
  limitFov: true,
  extraStats: [],
});
Class.nailgunTurret = makeTurret("nailgun", {
  canRepel: true,
  limitFov: true,
  extraStats: [],
});
...
Class.swarmerTurret = makeTurret("swarmer", {
  canRepel: true,
  limitFov: true,
  extraStats: [],
});
...
Class.autoSmasherMissileTurret = makeTurret(
  ...
  },
  {
    fov: 5,
    independent: true,
    aiSettings: { SKYNET: true, BLIND: true },
    extraStats: [],
  }
);
...
Class.baseSwarmTurret = makeTurret(
  ...
  },
  {
    label: "Protector",
    independent: true,
    aiSettings: { NO_LEAD: true, LIKES_SHAPES: true },
  }
);
