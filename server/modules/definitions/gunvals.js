...
// Bases
    ...
    factory: { reload: 48, shudder: 0.1, size: 0.7, damage: 0.2, speed: 2.2, spray: 0.1 },
...
// Snipers
    sniper: { reload: 1.35, shudder: 0.25, damage: 1.1, pen: 0.6, speed: 1.3, maxSpeed: 1.5, density: 1.5, spray: 0.2, resist: 1.15 },
...
// Drones
    ...
    summoner: { reload: 0.4, size: 1.125, health: 1.1, damage: 0.8, pen: 1.1, density: 0.8 },
...
// Heavy cannons
    ...
    shotgun: { reload: 8, recoil: 0.4, size: 1.5, damage: 0.2, pen: 0.8, speed: 1.8, maxSpeed: 0.6, density: 1.2, spray: 1.2 },
...
// Traps and blocks
    setTrap: { reload: 1.28, recoil: 1, shudder: 1, size: 1.55, health: 1, damage: 1.8, pen: 1.3, speed: 1.55, maxSpeed: 1.75, range: 1.2, resist: 1.25 },
    construct: { reload: 1.3, size: 1.05, maxSpeed: 1.4 },
